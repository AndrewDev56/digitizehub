      ...
      <div className="relative mx-auto max-w-[1100px] px-6 md:px-9">
        <FadeIn direction="up">
          <h2 className="text-center font-heading text-3xl font-normal tracking-[-0.02em] text-white md:text-5xl">
            Our <span className="font-accent italic text-accent-from">Story</span>
          </h2>
        </FadeIn>
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 md:mt-20 md:grid-cols-2 md:gap-16">
          <FadeIn direction="right" delay={0.15}>
            <p className="font-body text-sm leading-relaxed text-white/70 md:text-base">
              Digitize Hub started because we kept meeting the same
          ...
          <FadeIn direction="left" delay={0.25}>
            <p className="font-body text-sm leading-relaxed text-white/70 md:mt-16 md:text-base">
        ...
        <FadeIn direction="up" delay={0.35} className="relative mt-24 md:mt-32">
          <span
            aria-hidden
          ...
          <p className="max-w-xl font-accent text-2xl text-white italic md:text-4xl">
            <span className="font-heading not-italic font-semibold text-accent-from">
              One Team
            </span>{" "}
